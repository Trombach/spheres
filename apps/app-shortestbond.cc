...
int main (int argc, char *argv[])
{
    ...
    vector<double> allShortestBonds;
    for (vector<structure>::size_type i = 0; i < optKS.size(); i++)
    {
        ...
        cout << optKS[i].getNumber() << ": " << bonds[0] << endl;
        allShortestBonds.push_back(bonds[0]);
    }

    sort (allShortestBonds.begin(), allShortestBonds.end());
    cout << "Shortest: " << allShortestBonds[0] << endl; 
